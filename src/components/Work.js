      ...
      <div className='flex flex-col lg:flex-row gap-x-10'>
        ...
        className='flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0'>
          <div>
            ...
            <p className='max-w-sm mb-16'>The projects are developed by using javascript, typeScript, reactJs, nextJs, nodeJs and tailwind css. The most recent technolgies to build a projects</p>
